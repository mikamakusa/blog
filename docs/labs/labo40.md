---
title: Hardening d'instances Consul et Vault, déploiement sur Kubernetes 
created: 2021-01-04
author:
  - mikamakusa
tags:
  ...
  - kubernetes
---
# Hardening d'instances Consul et Vault et déploiement sur Kubernetes
...
Dans [l'article précédent](labo39.md) j'avais continué mon exploration de Vault en vous proposant un moyen relativement simple de remplacer le *Secret Manager* de **Kubernetes** par un cluster **Vault** externe...et d'après les quelques retours que j'ai eu sur **LinkedIn**, vous avez apprécié.    
